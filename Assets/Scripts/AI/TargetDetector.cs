...
public class TargetDetector : Detector {
    ...
    public override void Detect(AIData aiData) {
        ...
        if (playerCollider != null) {
            ...
            RaycastHit2D hit = Physics2D.Raycast(transform.position, dir, detectionRadius, obstacleLayer);

            if (hit.collider != null && (playerLayer & (1 << hit.collider.gameObject.layer)) != 0) {
                // Debug.DrawRay(transform.position, dir * detectionRadius, Color.magenta);
